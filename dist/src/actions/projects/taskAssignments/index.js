    ...
    return ({
        all: function (_a) {
            ...
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0: return [4 /*yield*/, request("task_assignments?" + buildParamStringFromObj({
                                is_active: is_active,
        ...
        getPerProject: function (project_id) { return function (_a) {
            ...
            return __awaiter(_this, void 0, void 0, function () {
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0: return [4 /*yield*/, request("project/" + project_id + "/task_assignments?" + buildParamStringFromObj({
                                is_active: is_active,
                                updated_since: updated_since,
                                page: page,
                                per_page: per_page
