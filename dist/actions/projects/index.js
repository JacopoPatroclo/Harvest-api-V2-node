...
var index_1 = require("./taskAssignments/index");
var index_2 = require("./userAssignments/index");
exports.default = (function (client) { return ({
    task_assignment: index_1.default(client),
    user_assignment: index_2.default(client),
    all: function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_b) {
                return [2 /*return*/, client.request("projects?" + param_1.buildParamStringFromObj({
                        is_active: is_active,
                        client_id: client_id,
